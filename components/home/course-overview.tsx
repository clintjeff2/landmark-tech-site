...
export default function CourseOverview() {
  const modules = [
    { name: "Linux & Shell Scripting", hours: "40", icon: "🐧", color: "text-teal" },
    { name: "Git & GitHub", hours: "12", icon: "🔀", color: "text-orange" },
    { name: "Maven & Build Tools", hours: "4", icon: "🔨", color: "text-purple" },
    { name: "Jenkins CI/CD", hours: "24", icon: "🚀", color: "text-cyan" },
    { name: "Docker Containerization", hours: "18", icon: "🐳", color: "text-pink" },
    { name: "Kubernetes Orchestration", hours: "27", icon: "☸️", color: "text-teal" },
    { name: "Ansible Automation", hours: "16", icon: "⚙️", color: "text-orange" },
    { name: "AWS Cloud Computing", hours: "32", icon: "☁️", color: "text-purple" },
    { name: "Terraform IaC", hours: "12", icon: "🏗️", color: "text-cyan" },
  ]
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-4xl md:text-5xl font-bold text-foreground text-balance">
                DevOps E. Degree <span className="gradient-text-purple">Curriculum</span>
              </h2>
              <p className="text-xl text-muted-foreground leading-relaxed text-pretty">
                Comprehensive training covering all essential DevOps tools and practices. From Linux fundamentals to
              ...
              {modules.map((module, index) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    <span className="text-2xl group-hover:scale-110 transition-transform">{module.icon}</span>
                    <span className={`font-semibold ${module.color} group-hover:text-foreground transition-colors`}>
                      {module.name}
                    </span>
                  </div>
                  <div className="flex items-center space-x-2 text-muted-foreground">
                    <Clock size={16} className={module.color} />
                    <span className="text-sm font-medium">{module.hours}hrs</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="flex items-center space-x-4 pt-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-semibold gradient-text-purple">185+ Hours Total</span>
              </div>
              <div className="h-6 w-px bg-gradient-to-b from-purple via-teal to-orange" />
              <div className="flex items-center space-x-2">
                <Award size={20} className="text-teal" />
                <span className="font-semibold gradient-text-teal">Certificate Included</span>
              </div>
            </div>
          </div>
            ...
            <div className="relative p-8 rounded-2xl glass border-2 border-purple/30 shadow-2xl">
              ...
              <div className="relative space-y-6">
                <div className="space-y-2">
                  <h3 className="text-2xl font-bold gradient-text-purple">What You Get</h3>
                  <p className="text-muted-foreground">Everything you need to become a DevOps engineer</p>
                </div>
                ...
                <div className="pt-6 border-t border-border space-y-4">
                  <div className="flex items-baseline justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-5xl font-bold gradient-text-orange-red">$3,000</div>
                      <div className="text-sm text-muted-foreground">Non-refundable (Class 41)</div>
                    </div>
                  </div>

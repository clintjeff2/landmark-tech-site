        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-balance">
              Transform Your Career with <span className="gradient-text-purple">DevOps</span>{" "}
            ...
            <p className="text-xl text-muted-foreground leading-relaxed text-pretty">
              ...
              <span className="text-foreground font-bold"> $3,000 comprehensive program</span> with job assistance and
              real-world projects.
            </p>
            ...
            <div className="flex items-center space-x-8 pt-4">
              <div className="group">
                <div className="text-3xl font-bold gradient-text-purple">18+</div>
                <div className="text-sm text-muted-foreground">Years Experience</div>
              </div>
              <div className="h-12 w-px bg-gradient-to-b from-purple via-teal to-orange" />
              <div className="group">
                <div className="text-3xl font-bold gradient-text-teal">5000+</div>
          ...
          <div className="relative lg:h-[600px] animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            <div className="relative rounded-2xl overflow-hidden border-2 border-purple/30 glass shadow-2xl">
              {/* Instructor on Zoom mockup */}
              <div className="aspect-video bg-gradient-to-br from-purple/20 via-card to-teal/20 p-8 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="text-center space-y-4 relative z-10">
                  <div className="w-32 h-32 mx-auto rounded-full gradient-purple-pink flex items-center justify-center animate-glow">
                    <Play size={48} className="text-white" />
                  </div>
                  <div className="space-y-2">
                    <h3 className="text-2xl font-bold text-foreground">Live Interactive Training</h3>
                    <p className="text-muted-foreground">Join expert-led sessions with hands-on labs</p>
                  </div>
                </div>
              </div>

              <div className="absolute bottom-4 left-4 right-4 glass rounded-lg border border-teal/30 p-4 shadow-xl">
                ...
                <div className="font-mono text-sm space-y-1">
                  <div className="text-teal">$ kubectl get pods</div>
                  <div className="text-muted-foreground">
                    NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;READY&nbsp;&nbsp;&nbsp;STATUS
                  </div>
                  <div className="text-foreground">
                    webapp-5d4b7c&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1/1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Running
                  </div>
                  <div className="text-foreground">
                    api-server-8f9a2&nbsp;&nbsp;&nbsp;1/1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Running
                  </div>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              style={{ animationDelay: "2s" }}
            >
              <div className="text-lg font-bold text-orange">14</div>
